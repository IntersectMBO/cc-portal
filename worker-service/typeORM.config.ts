...
import { HotAddress } from './src/vote/entities/hotaddress.entity';
import { User } from './src/vote/entities/user.entity';
...
export default new DataSource({
  ...
  entities: [Vote, HotAddress, User, GovActionProposal],
});
