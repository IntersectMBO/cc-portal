...
describe('VoteService', () => {
  ...
  const mockVotes: Vote[] = [
    ...
    },
    {
      ...
      comment: 'test3',
      vote: 'Yes',
      voteMetadataUrl: 'voteMetadataUrl_3',
  ...
  const mockDbSyncData: object[] = [
    {
      ...
      voting_anchor_id: '5',
      type: 'InfoAction',
      gap_url: 'https://gap-url-1.jsonld',
      vote_url: 'https://vote-url-1.jsonld',
      epoch_status: 'ACTIVE',
      end_time: null,
    ...
    },
    {
      ...
      voting_anchor_id: '5',
      type: 'InfoAction',
      gap_url: 'https://gap-url-2.jsonld',
      vote_url: 'https://vote-url-2.jsonld',
      epoch_status: 'ACTIVE',
      end_time: null,
    ...
    },
    {
      ...
      voting_anchor_id: '8',
      type: 'InfoAction',
      gap_url: 'https://gap-url-3.jsonld',
      vote_url: 'https://vote-url-3.jsonld',
      epoch_status: 'ACTIVE',
      end_time: null,
