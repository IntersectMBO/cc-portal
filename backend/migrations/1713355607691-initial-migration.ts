...
export class InitialMigration1713355607691 implements MigrationInterface {
  name = 'InitialMigration1713355607691';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "ipfs_metadata" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "cid" character varying NOT NULL, "blake2b" character varying NOT NULL, "content_type" character varying NOT NULL, "title" character varying NOT NULL, "content" text NOT NULL, "version" character varying NOT NULL, CONSTRAINT "PK_b786201a24f60a130e0f62027af" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
