...
export class InitialMigration1713254318839 implements MigrationInterface {
  name = 'InitialMigration1713254318839';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "ipfs" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "cid" character varying NOT NULL, "content_type" character varying NOT NULL, "content" text NOT NULL, "version" character varying NOT NULL, CONSTRAINT "PK_af553336f95ba7f14152e2048ee" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
